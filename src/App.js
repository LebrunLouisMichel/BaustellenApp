...
/**
 * @version 1.0
 * @author Louis-Michel Lebrun <lebrunlouismichel@gmail.com>
 * @description Diese App ist eine Strassen Baustellen Einsatzliste mit React.js und separatem Model, welche Offline verwendet werden kann
...
class App extends React.Component {
  ...
  /**
   * Pusht den eingegebenen Artikel in der aktivenGruppe
   */
  artikelHinzufuegen() {
  ...
  /**
   * Setzt die ausgewählte Gruppe auf Aktiv
   * @param {Gruppe} gruppe - die ausgewählte nun aktive Gruppe
   */
  ...
  /**
   * Öffnet das Dialogfenster zwecks Sortierung der Gruppen
   * @param {Reihenfolge} reihenfolge - die ausgewählte Reihenfolge
   * @param {Sortieren} sortieren - die Auf bzw. Abwärssortierung
   */
      ...
      <div id="container">
        ...
        <footer>
          <button className="mdc-button mdc-button--raised"
            ...
            <span className="mdc-button__ripple"></span> Einsätze
          </button>
          <button className="mdc-button mdc-button--raised"
